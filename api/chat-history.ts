  ...
  if (req.method === "GET" && req.query.action === "asbl-spec-create-fields") {
    ...
    try {
      ...
      const desired: Array<{ section: string; api: string; spec: any }> = [
        ...
        { section: "9.1", api: "Lead_Source_Detail", spec: { field_label: "Source Detail", data_type: "picklist", pick_list_values: pickList(["Website Chatbot", "WhatsApp Direct", "Manual Entry", "FIM Forms", "Channel Partner"]) } },
        { section: "9.1", api: "Visitor_ID", spec: { field_label: "Visitor ID", data_type: "text", length: 100 } },
        { section: "9.1", api: "Session_ID", spec: { field_label: "Origin Session ID", data_type: "text", length: 100 } },
        { section: "9.1", api: "GCLID", spec: { field_label: "Google Click ID", data_type: "text", length: 255 } },
        { section: "9.1", api: "FBCLID", spec: { field_label: "Meta Click ID", data_type: "text", length: 255 } },
        { section: "9.1", api: "WBRAID", spec: { field_label: "Web-to-app GAds ID", data_type: "text", length: 255 } },
        { section: "9.1", api: "GBRAID", spec: { field_label: "iOS GAds ID", data_type: "text", length: 255 } },
        { section: "9.1", api: "Landing_Page", spec: { field_label: "Landing Page URL", data_type: "website" } },
        { section: "9.1", api: "Referrer_Domain", spec: { field_label: "Referrer Domain", data_type: "text", length: 200 } },
        { section: "9.1", api: "Device_Fingerprint", spec: { field_label: "Device Fingerprint", data_type: "text", length: 200 } },
        { section: "9.1", api: "IP_City", spec: { field_label: "IP City", data_type: "text", length: 80 } },
        { section: "9.1", api: "IP_Country", spec: { field_label: "IP Country", data_type: "text", length: 10 } },
        { section: "9.1", api: "First_Seen_At", spec: { field_label: "First Seen", data_type: "datetime" } },

        // 9.2 Stage & Status (THE CORE STATE MACHINE)
        { section: "9.2", api: "Stage", spec: { field_label: "Stage", data_type: "picklist", pick_list_values: pickList(["New Lead", "In Conversation", "Site Visit Scheduled", "Site Visit Done", "Booked", "Closed"]) } },
        { section: "9.2", api: "Status", spec: { field_label: "Status", data_type: "picklist", pick_list_values: pickList(["Outreach Pending", "Talking", "Awaiting Reply", "No Response", "Callback Pending"]) } },
        { section: "9.2", api: "Callback_Source", spec: { field_label: "Callback Source", data_type: "picklist", pick_list_values: pickList(["Customer Requested", "System Scheduled"]) } },
        { section: "9.2", api: "Closure_Reason", spec: { field_label: "Closure Reason", data_type: "picklist", pick_list_values: pickList(["Not Interested", "Unreachable", "Wrong Number", "Broker", "Visit No-Show", "Opted Out", "Disqualified"]) } },
        { section: "9.2", api: "Stage_Updated_At", spec: { field_label: "Stage Updated At", data_type: "datetime" } },
        { section: "9.2", api: "Status_Updated_At", spec: { field_label: "Status Updated At", data_type: "datetime" } },
        { section: "9.2", api: "Last_State_Change_Source", spec: { field_label: "State Source", data_type: "picklist", pick_list_values: pickList(["whatsapp_bot", "voice_bot", "chatbot", "system", "vendor_webhook", "manual"]) } },
        { section: "9.2", api: "Last_State_Change_Reason", spec: { field_label: "State Reason", data_type: "text", length: 200 } },

        // 9.3 WhatsApp Channel
        { section: "9.3", api: "WhatsApp_State", spec: { field_label: "WhatsApp State", data_type: "picklist", pick_list_values: pickList(["Not Started", "Template Sent", "Delivered", "Read", "Replied", "Bot Active", "Awaiting Reply", "Stalled 24h", "Opted Out"]) } },
        { section: "9.3", api: "WhatsApp_Last_Activity_At", spec: { field_label: "WhatsApp Last Activity", data_type: "datetime" } },
        { section: "9.3", api: "WhatsApp_Template_Last_Sent", spec: { field_label: "Last Template Sent", data_type: "text", length: 100 } },
        { section: "9.3", api: "WhatsApp_Reply_Count", spec: { field_label: "WhatsApp Reply Count", data_type: "integer" } },
        { section: "9.3", api: "WhatsApp_Service_Window_Expires_At", spec: { field_label: "WA 24h Window Expires", data_type: "datetime" } },
        { section: "9.3", api: "Opt_Out_WhatsApp", spec: { field_label: "Opted Out of WhatsApp", data_type: "boolean" } },

        // 9.4 Voice Channel
        { section: "9.4", api: "Call_State", spec: { field_label: "Call State", data_type: "picklist", pick_list_values: pickList(["Not Started", "Dialing", "Connected", "In Progress", "Voicemail", "No Answer", "Disconnected", "Completed", "DNC"]) } },
        { section: "9.4", api: "Call_Last_Attempt_At", spec: { field_label: "Last Call Attempt", data_type: "datetime" } },
        { section: "9.4", api: "Call_Connected_Count", spec: { field_label: "Calls Connected", data_type: "integer" } },
        { section: "9.4", api: "Call_Last_Disposition", spec: { field_label: "Last Call Disposition", data_type: "text", length: 200 } },
        { section: "9.4", api: "Preferred_Callback_Time", spec: { field_label: "Preferred Callback Time", data_type: "datetime" } },
        { section: "9.4", api: "Opt_Out_Calls", spec: { field_label: "Do Not Call", data_type: "boolean" } },
        ...
        { section: "9.5", api: "Bot_Last_Cost_Path", spec: { field_label: "Last Classifier Path", data_type: "picklist", pick_list_values: pickList(["rules", "cache", "llm"]) } },
        ...
        { section: "9.6", api: "Workplace_Area", spec: { field_label: "Workplace Area", data_type: "text", length: 100 } },
        { section: "9.6", api: "Loan_Required", spec: { field_label: "Loan Required", data_type: "picklist", pick_list_values: pickList(["yes", "no", "unsure"]) } },
        { section: "9.6", api: "Competitor_Projects", spec: { field_label: "Competitor Projects", data_type: "multiselectpicklist", pick_list_values: pickList(["My Home", "Aparna", "Rajapushpa", "Prestige", "Sumadhura", "Lodha", "DLF", "Brigade", "Other"]) } },
        ...
        // 9.8 Site Visit
        { section: "9.8", api: "Site_Visit_Date", spec: { field_label: "Visit Date", data_type: "date" } },
        { section: "9.8", api: "Site_Visit_Slot", spec: { field_label: "Visit Slot", data_type: "text", length: 40 } },
        { section: "9.8", api: "Site_Visit_Confirmation_Source", spec: { field_label: "Confirmed Via", data_type: "picklist", pick_list_values: pickList(["WhatsApp", "Voice", "Web"]) } },
        { section: "9.8", api: "Site_Visit_Reminder_24h_Sent", spec: { field_label: "Reminder 24h Sent", data_type: "boolean" } },
        { section: "9.8", api: "Site_Visit_Reminder_3h_Sent", spec: { field_label: "Reminder 3h Sent", data_type: "boolean" } },
        { section: "9.8", api: "Site_Visit_Attended", spec: { field_label: "Visit Attended", data_type: "boolean" } },
        { section: "9.8", api: "Site_Visit_Attended_At", spec: { field_label: "Visit Attended At", data_type: "datetime" } },

        // 9.9 Outcome
        { section: "9.9", api: "Booking_Token_Paid", spec: { field_label: "Token Paid", data_type: "boolean" } },
        { section: "9.9", api: "Booking_Amount", spec: { field_label: "Booking Amount", data_type: "currency" } },
        { section: "9.9", api: "Booking_Date", spec: { field_label: "Booking Date", data_type: "date" } },
        ...
        { section: "9.11", api: "Next_Action_At", spec: { field_label: "Next Action At", data_type: "datetime" } },
        { section: "9.11", api: "Next_Action_Type", spec: { field_label: "Next Action Type", data_type: "picklist", pick_list_values: pickList(["send_wa_template", "send_wa_message", "dial", "send_reminder", "no_action"]) } },
        { section: "9.11", api: "Active_Cadence", spec: { field_label: "Active Cadence", data_type: "picklist", pick_list_values: pickList(["outreach", "recovery", "cooled", "reminder", "decision_followup", "none"]) } },
        { section: "9.11", api: "Cadence_Step", spec: { field_label: "Cadence Step", data_type: "integer" } },
        { section: "9.11", api: "Lead_Locked_For_Audit", spec: { field_label: "Audit Lock", data_type: "boolean" } },
      ];
